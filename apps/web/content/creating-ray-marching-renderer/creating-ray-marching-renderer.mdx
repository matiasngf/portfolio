...
In this post we will create a simple setup for a ray marching renderer that will help in future projects. It will help you understand how it is built.

OK but, why? But what is ray marching exactly?
...
* <a className="text-link" href="https://www.youtube.com/watch?v=Cp5WWtMoeKg&t=1s&ab_channel=SebastianLague" target="_blank">Coding Adventure: Ray Marching (by SebastianLague)</a>
* <a className="text-link" href="https://www.youtube.com/watch?v=BNZtUB7yhX4&t=164s&ab_channel=SimonDev" target="_blank">Ray Marching, and making 3D Worlds with Math (by SimonDev)</a>
...
If you want to implement this experiment on your own, I recommend you
<a className="text-link" href="https://github.com/matiasngf/ray-marching-tutorial-starter" target="_blank">download this repository.</a> 
It has a basic ViteJs app setup.
...
Open the file `src/shaders/ray-marching.ts`. You will see an empty string variable called `fragmentShader`. Add the following code to it:
...
Your code should look something like <a className="text-link" href="https://github.com/matiasngf/ray-marching-tutorial-starter/blob/solution/src/shaders/ray-marching.ts" target="_blank">this</a>.

Since we are cloning the properties from our ThreeJs camera, we can use the `orbitControls` to move through the scene.

🥳 Congratulations! You just rendered your first scene using ray-marching. This is a solid start. There are some other topics you can research to expand your knowledge:

...
In this post, we'll dive into the exciting world of ray marching - a powerful rendering technique that lets you create stunning visuals by shooting rays from each pixel and evaluating a distance function along their path. To make all this possible, we will start by creating a simple renderer to help help you understand how it works and how to build your own. Click [here](/experiments/ray-marching-simple/play) to see the final result of this tutorial.
...
For this post, I'll assume some basic knowledge in ThreeJs and shaders, but if you are new to this, I recommend you check out this video first:
